        ...
        <head><link href="https://fonts.googleapis.com/css?family=Permanent+Marker" rel="stylesheet"/> </head>
          ...
          <main > 
            <table className="playarea">
              ...
              <tr> 
                <td>{this.state.board[0][0]}</td>
                <td>{this.state.board[0][1]}</td>
                <td>{this.state.board[0][2]}</td>
                <td>{this.state.board[0][3]}</td>
                <td>{this.state.board[0][4]}</td>
                <td>{this.state.board[0][5]}</td>
                <td>{this.state.board[0][6]}</td>
                <td>{this.state.board[0][7]}</td>
              </tr>
              <tr> 
